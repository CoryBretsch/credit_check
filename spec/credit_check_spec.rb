...
RSpec.describe CreditCheck do
  ...
  it "can sum the card number according to Luhn Algo" do
    credit_check1 = CreditCheck.new("5541808923795240", 15000)
    credit_check2 = CreditCheck.new("4024007136512380", 7000)
  ...
  it "can determine a valid card number" do
    credit_check1 = CreditCheck.new("5541808923795240", 15000)
    invalid_number1 = CreditCheck.new("5541801923795240", 4000)
